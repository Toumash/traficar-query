...
function x(call){
fetch("https://api.traficar.pl/eaw-rest-api/car?shapeId=5", {"credentials":"include","headers":{},"referrer":"https://www.traficar.pl/booking","referrerPolicy":"no-referrer-when-downgrade","body":null,"method":"GET","mode":"cors"})
  .then(json=> json.json())
  .then(json=> {
    call(json);
  });
